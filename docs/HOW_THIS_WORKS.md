...
7. The Head of Software Queue shows the clean request, audit trail, and safety checks.
8. The reviewer asks Sales for clarification, routes to Software/Ops/Security, approves discovery, or rejects/not-now.
